...
DOCS_BOT_SYSTEM_PROMPT = """Du bist der MVA Docs-Assistent. Du hilfst Mitarbeitern beim Erstellen und Formulieren von Dokumenten, E-Mails, Protokollen und Berichten. Antworte immer auf Deutsch."""


async def get_docs_bot_response(user_message: str, conversation_history: list[dict]) -> str:
    """Erzeugt eine Docs-Bot-Antwort über Gemini 2.0 Flash."""
    try:
        ...
        model = genai.GenerativeModel(
            "gemini-2.0-flash",
            system_instruction=DOCS_BOT_SYSTEM_PROMPT,
        )
        ...
        log.error("Fehler bei Docs-Bot-Antwort: %s", e)
        return (
